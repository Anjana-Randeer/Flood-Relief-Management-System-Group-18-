...
This project is a web-based platform developed as part of the **CSC 1051 - Full-Stack Fundamentals** course at the **University of Sri Jayewardenepura**.It is designed to streamline the collection and management of relief requests for communities affected by natural disasters in Sri Lanka.

## 📋 Project Overview
The system provides a digital bridge between affected individuals and administrators.It allows households to submit specific relief requirements and enables administrators to monitor, filter, and manage these requests to ensure effective aid distribution.
...
1.  **`users`**: Stores account credentials and user profile information.
2.  **`relief_requests`**: Stores details such as relief type, district, GN division, household members, and disaster severity.
